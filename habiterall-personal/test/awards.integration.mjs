...
//
// `=== true` / `=== false`, never truthiness: this edition's rows carry
// SQLite's 0/1, so a route that forgot to coerce would answer `1` here and a
// truthy check would pass while the cloud edition answered `true` for the same
// habit — and Android's `archived: Boolean` refuses to deserialise the integer.
